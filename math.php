...
$mathManagers = getManager($conn, 'math');

$head = [];
$deputies = [];
$members = [];
while ($row = $mathManagers->fetch_assoc()) {
...
<head>
  ...
  <title>กลุ่มสาระการเรียนรู้คณิตศาสตร์</title>
            ...
            <div class="col-md-3 mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text"><?php echo $row['manager'];?>สาระการเรียนรู้คณิตศาสตร์</p>
                </div>
              </div>
            </div>
          <?php } ?>

...
$engManagers = getManager($conn, 'eng');

$head = [];
$deputies = [];
$members = [];
while ($row = $engManagers->fetch_assoc()) {
...
<head>
  ...
  <title>กลุ่มสาระการเรียนรู้ภาษาต่างประเทศ</title>
            ...
            <div class="col-md-3 mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text"><?php echo $row['manager'];?>สาระการเรียนรู้ภาษาต่างประเทศ</p>
                </div>
              </div>
            </div>
          <?php } ?>

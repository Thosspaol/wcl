                                            ...
                                            <div class="cardt rounded-0 shadow">
                                                ...
                                                <div class="card-body">
                                                    <div class="container-fluid">
                                                        <form action="save_schedule.php" method="post" id="schedule-form">
                                                            ...
                                                            <div class="form-group mb-2">
                                                                <label for="description" class="control-label">หมายเหตุ</label>
                                                            ...
                                                            <div class="form-group mb-2">
                                                                <label for="end_datetime" class="control-label">สิ้นสุด</label>
                                                ...
                                                <div class="card-footer">
                                                    <div class="text-center">
                                                        <button class="btn btn-success btn-sm rounded-0" type="submit" form="schedule-form"><i class="fa fa-save"></i> บันทึก</button>
                                                        <button class="btn btn-danger border btn-sm rounded-0" type="reset" form="schedule-form"><i class="fas fa-times"></i> ยกเลิก</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content rounded-0">
                                            ...
                                            <div class="modal-footer rounded-0">
                                                <div class="text-end">
                                                    <button type="button" class="btn btn-warning btn-sm rounded-0" id="edit" data-id=""><i class="fas fa-pencil-alt"></i> แก้ไข</button>
                                                    <button type="button" class="btn btn-danger btn-sm rounded-0" id="delete" data-id=""><i class="fas fa-times"></i> ลบ</button>
                                                    <button type="button" class="btn btn-secondary btn-sm rounded-0" data-bs-dismiss="modal"><i class="fas fa-share-square"></i> ปิด</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-md-3">
                            <div class="card">
                                <form id="formData">
                                    <a href="../tables/index.php" title="ตารางสอน นักเรียน-คุณครู">
                                        <img alt="ตารางสอน นักเรียน-คุณครู" class="img-responsive ls-is-cached lazyloaded" src="../img/ตาราง.png" style="max-width: 75%; height: auto;">
                                    </a>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="card">
                                <form id="formData">
                                    <a href="../calendar/index.php" title="ปฏิทินกิจกรรม">
                                        <img alt="ปฏิทินกิจกรรม" class="img-responsive ls-is-cached lazyloaded" src="../img/ป.png" style="max-width: 75%; height: auto;">
                                    </a>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="card">
                                <form id="formData">
                                    <a href="../grade/index.php" title="เกรดนักเรียน">
                                        <img alt="ออกเกรดนักเรียน" class="img-responsive ls-is-cached lazyloaded" src="../img/เกรด.png" style="max-width: 75%; height: auto;">
                                    </a>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="card">
                                <form id="formData">
                                    <a href="../pdf/index.php" title="เอกสารดาวน์โหลด">
                                        <img alt="เอกสารดาวน์โหลด" class="img-responsive ls-is-cached lazyloaded" src="../img/ดาว.png" style="max-width: 75%; height: auto;">
                                    </a>
                                </form>
                            </div>
                        </div>

                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-md-3">
                            <div class="card">
                                <form id="formData">
                                    <a href="../tables/index.php" title="ตารางสอน ครู-นักเรียน">
                                        <img alt="ตารางสอน ครู-นักเรียน" class="img-responsive ls-is-cached lazyloaded" src="../img/ตารางสอน.png" style="max-width: 75%; height: auto;">
                                    </a>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <form id="formData">
                                    <a href="../calendar/index.php" title="ปฏิทินกิจกรรม">
                                        <img alt="ปฏิทินกิจกรรม" class="img-responsive ls-is-cached lazyloaded" src="../img/ปฏิทิน.png" style="max-width: 75%; height: auto;">
                                    </a>
                                </form>
                            </div>
                        </div>

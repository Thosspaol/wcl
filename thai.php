...
$thaiManagers = getManager($conn, 'thai');

$head = [];
$deputies = [];
$members = [];
while ($row = $thaiManagers->fetch_assoc()) {
...
<head>
  ...
  <title>กลุ่มสาระการเรียนรู้ภาษาไทย</title>
            ...
            <div class="col-md-3 mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text"><?php echo $row['manager'];?>สาระการเรียนรู้ภาษาไทย</p>
                </div>
              </div>
            </div>
          <?php } ?>

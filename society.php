...
$societyManagers = getManager($conn, 'society');

$head = [];
$deputies = [];
$members = [];
while ($row = $societyManagers->fetch_assoc()) {
...
<head>
  ...
  <title>กลุ่มสาระการเรียนรู้สังคมศึกษา ศาสนาและวัฒนธรรม</title>
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              ...
              <p>สังคมศึกษา ศาสนาและวัฒนธรรม</p>              
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-md-3 mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text"><?php echo $row['manager'];?>สาระการเรียนรู้สังคมศึกษา ศาสนาและวัฒนธรรม</p>
                </div>
              </div>
            </div>
          <?php } ?>
